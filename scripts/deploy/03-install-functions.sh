...
FUNCTIONS=(main publish-echo discovery-feed echo-share moderate-echo suspend-account delete-account generate-echo-hook transcribe-audio cleanup-expired-audios)
